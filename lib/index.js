...
export const FormItem = presets.Component({
    properties: {
        modelName: {
            type: String,
            value: ''
...
export const Plain = presets.Component(descendant, defaults.MiniComponent, FormItem);

export const Input = presets.Component(descendant, defaults.MiniComponent, FormItem, {
    properties: {
        type: {
            type: String,
            value: 'text'
...
export const Textarea = presets.Component(descendant, defaults.MiniComponent, FormItem);

const SingleChoice = presets.Component(descendant, defaults.MiniComponent, FormItem, {
    methods: {
        getValueView(modelItem) {
...
export const Radio = presets.Component(SingleChoice);
export const Picker = presets.Component(SingleChoice, {
    methods: {
        onChanged(e) {
...
export const Checkbox = presets.Component(descendant, defaults.MiniComponent, FormItem, {
    methods: {
        getValueView(modelItem) {
            const views = [];
...
export const Files = presets.Component(descendant, defaults.MiniComponent, FormItem, {
    data: {
        flying: null
    },
    methods: {
...
export const Button = presets.Component(descendant, defaults.MiniComponent);