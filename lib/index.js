...
export const Input = function (option, factory = MiniComponent) {
    return FormInputComponent(option, descendant, factory);
}

const FormTextareaComponent = createPresetComponent({
    options: {virtualHost: true},
    properties: {},
    behaviors: [FormItemBehavior]
});

export const Textarea = function (option, factory = MiniComponent) {
    return FormTextareaComponent(option, descendant, factory);
}
...
export const Radio = function (option, factory = MiniComponent) {
...
export const Picker = function (option, factory = MiniComponent) {
...
export const Checkbox = function (option, factory = MiniComponent) {
...
export const Button = function (option, factory = MiniComponent) {
